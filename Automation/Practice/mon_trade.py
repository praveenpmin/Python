...
for row in ws1['A']:
    ...
    if (row.value is not None):
        ...
        try:
            ...
            #print(day_Low)
            ws2['B'+str(B)]=stk_Price
            ws2['C'+str(C)]=day_Low
            ws2['D'+str(D)]=day_High
            ws2['E'+str(E)]=yr_Low
            ws2['F'+str(F)]=yr_High
            ws2['G'+str(G)]=Diffwithlow
            ws2['H'+str(H)]=Diffwithhigh
            ws2['I'+str(I)]=DiffbetweenlowandHigh
            ws2['J'+str(J)]=DiffbetweenDayhighandyrhigh
            ws2['K'+str(K)]=datetime.now()
